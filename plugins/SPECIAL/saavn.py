...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton('💖🇮🇳✨ Made By ✨🇮🇳💖', url='https://t.me/+e_UqPGvuQ5E5NGU1')]])
...
#   album_id = r.json()[0]["albumid"]
    ...
    buttons = [[
        InlineKeyboardButton("JOIN MOVIES", url="https://t.me/+e_UqPGvuQ5E5NGU1")
    ]]                           
