...
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/84cd1363550d1032abc30.jpg")
...
BR_IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", f"{script.NOR_TXT}")
BATCH_LINK = environ.get('BATCH_LINK',"")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", f"{script.CUSTOM_FILE_CAPTION}")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", f"{script.NOR_TXT}")
